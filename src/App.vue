<template>
  ...
  <div
      ...
      :class="{ 'overflow-hidden': isSideMenuOpen, 'dark': isDark }"
    >
      <!-- Desktop sidebar -->
      <aside
          ...
          <ul class="mt-6">
            <li class="relative px-6 py-3">
              ...
              <a
                ...
                :class="{ 'text-gray-800 dark:text-gray-100': $route.path === '/dashboard' }"
                href="/dashboard"
              >
                <svg
                  class="w-5 h-5"
      ...
      <div class="flex flex-col flex-1">
          ...
          >
            ...
            <div class="flex justify-center flex-1 lg:mr-32">
              ...
              >
                ...
                <input
                  class="w-full pl-8 p-2 text-sm text-gray-700 placeholder-gray-600 bg-gray-100 border-0 rounded-md dark:placeholder-gray-500 dark:focus:shadow-outline-gray dark:focus:placeholder-gray-600 dark:bg-gray-700 dark:text-gray-200 focus:placeholder-gray-500 focus:bg-white focus:border-purple-300 focus:outline-none focus:shadow-outline-purple form-input"
                  type="text"
        ...
        <main class="h-full pb-16 overflow-y-auto dark:bg-gray-900">
    ...
    export default {
        ...
        setup () {
            ...
            if (window.localStorage.getItem('dark')) {
                isDark.value = JSON.parse(window.localStorage.getItem('dark'));
            } else {
